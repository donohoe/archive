...
<head>
	...
	<title>Archive</title>
	<link rel='stylesheet' href='styles.css?ver=1.0.1' media='all' />
</head>
<body>
<div id="page">
	<header>
					...
					"<div id=\"info\">",
						"<p>",
							...
							"<a href=\"{$f["link"]}\" target=\"_blank\" class=\"icon-link\" >",
								"<img src=\"./_media/icon-link.svg\" alt=\"Open in New Tab\"/>",
							"</a>",
						"</p>",
					"</div>",
					"<div id=\"preview\">",
...
?>
	...
	<footer>
		<p><a href="https://github.com/donohoe">Github</a></p>
	</footer>
	<div style="display: none;">
		<?php include './_media/icon-file-symbol.svg'; ?>
	</div>
</div>
</body>
</html>
